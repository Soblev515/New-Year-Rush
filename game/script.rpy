...
define ti = Character('Таня', color="#696969")

define book = Character(what_italic = True, kind = nvl)

#Тренинг или книги
define training = False
#Хорошее знакомство с Никай
define goodAcquaintance = False
#Плохое знакомство с Никай
...
label start:
    label Day_1:
        ...
        menu:
            ...
            "Нет":
                ...
                "{cps=30}Открыв дверь и войдя в кабинет, начальник укоризненно на меня посмотрел и сказал, чтобы я всё-таки стучался.{w}
                Прекрасный совет.{w}
                Следовать ему я конечно же не буду.{/cps}"
    ...
    label Day_2:
        ...
        if training:
            ...
            ti"{cps=30}Согласна, проблема информации в интернете в том, что её много, но она часто плохо структурирована в отличии от книг.{/cps}"

            "{cps=30}Она посмотрела на часы.{/cps}"

            "{cps=30}Мне уже пора, но я думаю мы ещё увидимся с тобой здесь.{/cps}"
